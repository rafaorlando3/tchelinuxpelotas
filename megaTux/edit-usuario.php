...
<script language="Javascript">
    ...
    <form id="excluir" name="excluir" method="post" action="usuario-del.php" > <input type="hidden" name="id" value="<?php echo $id; ?>"/>   <button onclick="confirmacao();" class="btn btn-large btn-danger" >Excluir</button> 
     </form>
...
<form id="cadastros" method="post">
        ...
        <div class="form-group">
            ...
            <div class="btn-group" data-toggle="buttons">
                <label class="btn btn-primary">
                    <input type="radio" name="admin" value="1" <?php if($linha2['admin']==1){ echo "checked";} ?> onclick="mostra();" autocomplete="off">Sim
                </label>
                <label class="btn btn-primary active" id="js-btnNaoAluno">
                    <input type="radio" name="admin" value="0" autocomplete="off" <?php if($linha2['admin']==0){ echo "checked";} ?> onclick="esconde();" >Não
                </label>
            </div>
        </div>
    ...
    <div id="mostrasenha" class="form-group">
       ...
       <div class="form-group">
           <label for="presenca"><h4>Presença</h4></label>
         <div class="btn-group" data-toggle="buttons">
                <label class="btn btn-primary">
